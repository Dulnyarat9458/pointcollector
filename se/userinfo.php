                    ...
                    <div class="panel panel-default">
                        ...
                        <?php 
                          if (isset($_SESSION["delAdmin"])) {
                            echo '<div class="alert alert-danger"><center><strong>คุณไม่สามารถลบ Admin ออกจากระบบได้</strong></center></div>';
                            unset($_SESSION["delAdmin"]);
                          }
                          if (isset($_SESSION["editAdmin"])) {
                            echo '<div class="alert alert-danger"><center><strong>คุณไม่สามารถแก้ไข Admin ได้</strong></center></div>';
                        ...
                        ?>
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    <input type="email" class="form-control" id="inputemail" placeholder="   ข้อมูลลูกค้า" style="border: 2px solid #2D4262;
                            ...
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: center"><b>NO.</b></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-2"> ';
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: left"><b>ชื่อ</b></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-2"> ';
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: left"><b>นามสกุล</b></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-2"> ';
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: left"><b>อีเมล</b></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-2"> ';
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: left  "><b>แต้ม</b></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-2"> ';
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: left"><b>เบอร์</b></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-2"> ';
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: left"><b>บทบาท</b></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-1"> ';
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: right"></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-1"> ';
                            echo ' <tbody>';
                            ...
                            while ($row = $result->fetch()) {
                                ...
                                echo '<div class="col mb-1"> ';
                                echo '<tbody>';
                                echo '<tr><td><div style="text-align: center">' . $count . "</div></td></tr>";
                                echo '</tbody>';
                                echo '</div>';
                                echo '<div class="col mb-2"> ';
                                echo '<tbody>';
                                ...
                                echo '<div class="col mb-1"> ';
                                echo '<tbody>';
                                echo '<tr><td><div style="text-align: left;">' . $row[4] . "</div></td></tr>";
                                echo '</tbody>';
                                echo '</div>';
                                echo '<div class="col mb-1"> ';
                                echo '<tbody>';
                                echo '<tr><td><div style="text-align: left;">' . $row[5] . "</div></td></tr>";
                                echo '</tbody>';
                                echo '</div>';
                                echo '<div class="col mb-1"> ';
                                echo '<tbody>';
                                echo '<tr><td><div style="text-align: left;">' . $row[7] . "</div></td></tr>";
                                echo '</tbody>';
                                echo '</div>';
                                echo '<div class="col mb-1"> ';
                                echo '<tbody>';
                                echo '<tr><td><div style="text-align: left;">' . $row[8] . "</div></td></tr>";
                                echo '</tbody>';
                                echo '</div>';
                                echo '<div class="col mb-1"> ';
                                echo '<tbody>';
                                echo '<tr><td><div style="text-align: left;">' . $row[6] . "</div></td></tr>";
                                echo '</tbody>';
                                echo '</div>';
                                echo '<div class="col mb-1"> ';
                                echo '<tbody>';
                                echo "<tr><td><div style='float: right'><a href=" . "delete.php?id=" . $row['0'] . "><button type='button' class='btn btn-danger btn'>ลบผู้ใช้</button></a></div></td></tr>";
                                echo '</tbody>';
                                echo '</div>';
                                echo '<div class="col mb-1"> ';
                                echo '<tbody>';
                                echo "<tr><td><div style='float: left'><a href=" . "joint.php?id=" . $row['0'] . "><button type='button' class='btn btn-warning btn'>แก้ไข</button></a></div></td></tr>";
                                echo '</tbody>';
                                echo '</div>';
                                echo '</div>';
                                $conn = null;
