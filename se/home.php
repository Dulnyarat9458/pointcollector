...
<body>
    ...
    if (isset($_SESSION["id"])) {
        ...
        echo '<div class="w3-sidebar w3-bar-block" style="width:20%;right:0;background-color: #F0F0F0;">
        <div class="container w3-center">
            ...
            <p style="font-size: 24px;">
                ...
                <a href="login.php" style="font-size: 24px;">กรุณาเข้าสู่ระบบ</a> 
            <br><br>
            <p style="font-size: 24px;">หรือ</p>
            <a href="register.php" style="font-size: 24px;">สมัครสมาชิก</a>
        </div>
    </div>';
    }
    ?>
    ...
    <br><br>
    <h1 class="container" style="font-family: kanit; font-size: 100px">ยินดีต้อนรับ...</h1>
    ...
    <div class="col-md-2">
        <h3 style="background-color: #D09683;color: white;font-size: 24px;padding: 4%;font-weight: 600;">
        ...
        <div class="row">
            ...
            while ($objResult = $objQuery->fetch()) {
                ...
                if (fmod($count, 3) == 0) { ?>
                    ...
                    <div class="w3-third">
                        <img src="promotionImg/<?php echo $objResult["promotion_pic"]; ?>" style="width:380px;height:290px">
                        <br><br>
                        <h3 style="font-family:kanit;font-weight:bold"><?php echo $objResult["promotion_name"]; ?></h3>
                        <p style="color: gray;font-size:14px"><?php echo $objResult["description"]; ?></p>
                        <?php echo "<br><center><a href=" . "moreInfPromotion.php?id=" . $objResult["promotion_id"] . 
                        "><button type='button' class='btn btn-primary btn' style='background-color: #2D4262;'>เพิ่มเติม</button></a></center>"; ?>
                    </div>
