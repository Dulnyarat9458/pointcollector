...
<div class="w3-bar w3-large w3-text-white">
  ...
  <?php
  if (isset($_SESSION["noPro"])) {
    echo '<div class="alert alert-danger"><center><strong>กรุณาเลือกโปรโมชั่น</strong></center></div>';
    unset($_SESSION["noPro"]);
  }
  ...
  if (isset($_SESSION["notEnought"])) {
    echo '<div class="alert alert-danger"><center><strong>ผู้ใช้มีแต้มไม่พอ</strong></center></div>';
    unset($_SESSION["notEnought"]);
  }

  if (isset($_SESSION["found"])) {
    echo '<div class="alert alert-success"><center><strong>ใช้แต้มเรียบร้อยแล้ว</strong></center></div>';
    unset($_SESSION["found"]);
  }

  ?>
  <form action="useVerify.php" method="post">
            ...
            <center>
              <div class="panel-group" style="width: 100% ">
                <div class="panel panel-default" style="    
                  ...
                  <div class="row mb-3">
                    <label for="txt_name" class="col-sm-5 form-label">โปรโมชั่น: </label>
                    <div class="col-sm-6">
                      <select name="promotionN" id="promotionN">
                        <?php $count = 0;
                        ...
                        <?php while ($objResult = $objQuery->fetch()) { ?>
                          <option value="<?php echo $objResult["promotion_id"]; ?>"><?php echo $objResult["promotion_name"]; ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="txt_name" class="col-sm-5 form-label">จำนวนการใช้: </label>
                    <div class="col-sm-6">
                  ...
                  <div class="row">
                    <div class="col-md-12" style="text-align: center">
                      <button type="submit" class="btn btn-primary btn-lg" style="background-color: #2D4262;">ใช้แต้ม</button>
                    </div>
                  </div>
                </div>
            </center>
