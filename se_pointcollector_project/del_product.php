                ...
                <div class="panel-group">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    <input type="email" class="form-control" id="inputemail" placeholder="   ลบสินค้า" style="border: 2px solid #2D4262;
                            ...
                            echo ' <div class="col mb-2"> ';
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: left"><b>ชื่อสินค้า</b></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-2"> ';
                            echo ' <tbody>';
                            echo ' <tr><td><div style="text-align: left"><b>ราคา</b></div></td></tr>';
                            echo '</tbody>';
                            echo '</div>';
                            echo ' <div class="col mb-2"> ';
                            echo ' <tbody>';
                            ...
                            while ($row = $result->fetch()) {
                                ...
                                echo '<div class="col mb-2"> ';
                                echo '<tbody>';
                                echo "<tr><td><div style='float: left'><a href=" . "DeleteProductInMySql.php?id=" . $row['0'] . "><button type='button' class='btn btn-danger btn'>ลบสินค้า</button></a></div></td></tr>";
                                echo '</tbody>';
                                echo '</div>';
                                echo '</div>';
                                $conn = null;
