...
<body>
    <form name="formProduct" method="post" action="UploadProductToMySQL.php" enctype="multipart/form-data">
        <!--top icon-->
        <div class="container">
        ...
        if (isset($_SESSION["success"])) {
            echo '<div class="alert alert-success"><center><strong>เพิ่มสินค้าเรียบร้อยแล้ว</strong></center></div>';
                    ...
                    <div class="container">
                        ...
                        <center>
                            ...
                            border-radius: 20px; padding: 5%;">
                                    <div class="row mb-3">
                                        <label for="txt_name" class="col-sm-5 form-label">ชื่อสินค้า </label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="inputname" name="proName" placeholder="">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="txt_name" class="col-sm-5 form-label">ราคา </label>
                                        <div class="col-sm-6">
                                            <input type="number" class="form-control" id="inputname" name="proPrice" placeholder="">
                                        </div>บาท
                                    </div>
                                    <div class="row mb-3">
                                        <label for="txt_name" class="col-sm-5 form-label">แต้ม </label>
                                        <div class="col-sm-6">
                                            <input type="number" class="form-control" id="inputname" name="proPoint" placeholder="">
                                        </div>แต้ม
                                    </div>
                                    <div class="row mb-3">
